...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.sendPublicContactMessage(formData);
      setSuccess(true);
              ...
              <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="flex space-x-4">
                  <a
                    ...
                    className="w-10 h-10 bg-primary-100 dark:bg-primary-900 rounded-lg flex items-center justify-center hover:bg-primary-200 dark:hover:bg-primary-800 transition-colors duration-200"
                  >
